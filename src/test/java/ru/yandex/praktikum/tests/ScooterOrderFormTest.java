...
public class ScooterOrderFormTest {
    ...
    public ScooterOrderFormTest(String buttonOrder, String nameField, String lastNameField, String addressCustomersField, String metroStationField,
    ...
    public static Object[][]  getOrderFormData() {
        return new Object[][]{
                {"header", "Семен", "Семёнов", "Морская 25", "Лубянка", "+79024445599",
                        "20.08.2025", "сутки", "Серая безысходность", "Жду в срок"},
                {"footer", "Иван", "Иванов", "Ленина 99", "Аэропорт", "+79124445591",
                        "22.10.2025", "двое суток", "Чёрный жемчуг", "Привозите быстрее, очень жду!"},

        };
    }

    @Test
    public void shouldOrderPlacedPositiveResult(){
        ...
        orderScooter.clickOrderButtonInHeaderOrFooter(buttonOrder);
