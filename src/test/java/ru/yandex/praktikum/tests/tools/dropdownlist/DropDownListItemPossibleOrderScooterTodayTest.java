...
public class DropDownListItemPossibleOrderScooterTodayTest {
    private WebDriver driver;
    private final String question;
    private final String answer;
    private final boolean expectedResult;

    public DropDownListItemPossibleOrderScooterTodayTest(String question, String answer, boolean expectedResult) {
    ...
    public static Object[][] getTextData(){
        return new Object[][]{ {"Можно ли заказать самокат прямо на сегодня?",
                "Только начиная с завтрашнего дня. Но скоро станем расторопнее.", true}
        };
    }

    @Test
    public void shouldAnswerCorrespondQuestionPossibleOrderScooterToday(){
        ...
        boolean actualText = scooter.checkDropDownListItemPossibleOrderScooterToday(question, answer);
        assertEquals("Ответ несоответствует вопросу", expectedResult, actualText);
    }
