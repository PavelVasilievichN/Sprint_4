...
public class DropDownListTest {
    ...
    public DropDownListTest(int index, String question, String answer) {
        this.index = index;
    ...
    public static Object[][] getTextData(){
        return new Object[][]{ {0, "Сколько это стоит? И как оплатить?",
    ...
    @Test
    public void checkAnswerMatchesTheQuestion(){
        ...
        boolean actualResult = scooter.checkDropDownListItemQuestionAndAnswer(index, question, answer);
        assertTrue("Ответ должен соответствовать вопросу", actualResult);
    }
